...
it("returns multiple documents", async ({ expect, client, docs }) => {
	const res = await client.getAllByUIDs(docs.default.type, [docs.default.uid, docs.default2.uid])
...
it("includes filter", async ({ expect, client, docs }) => {
	await client.getAllByUIDs(docs.default.type, [docs.default.uid, docs.default2.uid])
