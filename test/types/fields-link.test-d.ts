...
import { LinkType, type BooleanField, type LinkField } from "../../src"
...
test("filled value with explicit variant", () => {
...
test("supports custom document type for document links", () => {
...
test("supports custom document language for document links", () => {
...
test("supports custom document data for document links", () => {
...
test("uses const object (not enum) to allow cross-version compatibility", () => {
