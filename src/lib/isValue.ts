import type { InjectMigrationSpecificTypes } from "../types/migration/Document.ts"
...
import type { ImageField } from "../types/value/image.ts"
...
import { type RTImageNode, RichTextNodeType } from "../types/value/richText.ts"
