declare type PredicateValue = string | number | Date;
declare const _default: {
    at(fragment: string, value: string | number | Date | PredicateValue[]): string;
    not(fragment: string, value: string | number | Date | PredicateValue[]): string;
